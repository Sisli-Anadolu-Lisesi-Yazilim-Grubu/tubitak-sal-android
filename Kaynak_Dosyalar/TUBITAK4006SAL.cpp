...
giris_ekrani::giris_ekrani() {
    ...
    timer->start(5000); // 5 sn bekleyip proje ekranını açar
}

proje_ekrani::proje_ekrani() {
    nesne1 = new TUBITAK::proje1; // nesneler
...
void proje_ekrani::on_bar_proje1_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/1.jpg' width='500' height='500' /></p><p>" + nesne1->metin1 + nesne1->yapan1 + "</p>";
...
void proje_ekrani::on_bar_proje8_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/8.jpg' width='500' height='500' /></p><p>" + nesne8->metin8 + nesne8->yapan8 + "</p>";
...
void proje_ekrani::on_bar_proje2_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/2.jpg' width='500' height='500' /></p><p>" + nesne2->metin2 + nesne2->yapan2 + "</p>";
...
void proje_ekrani::on_bar_proje3_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/3.jpg' width='500' height='500' /></p><p>" + nesne3->metin3 + nesne3->yapan3 + "</p>";
...
void proje_ekrani::on_bar_proje4_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/4.jpg' width='500' height='500' /></p><p>" + nesne4->metin4 + nesne4->yapan4 + "</p>";
...
void proje_ekrani::on_bar_proje9_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/9.jpg' width='500' height='500' /></p><p>" + nesne9->metin9 + nesne9->yapan9 + "</p>";
...
void proje_ekrani::on_bar_proje5_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/5.jpg' width='500' height='500' /></p><p>" + nesne5->metin5 + nesne5->yapan5 + "</p>";
...
void proje_ekrani::on_bar_proje7_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/7.jpg' width='500' height='500' /></p><p>" + nesne7->metin7 + nesne7->yapan7 + "</p>";
...
void proje_ekrani::on_bar_proje10_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/10.jpg' width='500' height='500' /></p><p>" + nesne10->metin10 + nesne10->yapan10 + "</p>";
...
void proje_ekrani::on_bar_proje13_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/13.jpg' width='500' height='500' /></p><p>" + nesne13->metin13 + nesne13->yapan13 + "</p>";
...
void proje_ekrani::on_bar_proje6_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/6.jpg' width='500' height='500' /></p><p>" + nesne6->metin6 + nesne6->yapan6 + "</p>";
...
void proje_ekrani::on_bar_proje11_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/11.jpg' width='500' height='500' /></p><p>" + nesne11->metin11 + nesne11->yapan11 + "</p>";
...
void proje_ekrani::on_bar_proje12_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/12.jpg' width='500' height='500' /></p><p>" + nesne12->metin12 + nesne12->yapan12 + "</p>";
...
void proje_ekrani::on_bar_proje15_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/15.jpg' width='500' height='500' /></p><p>" + nesne15->metin15 + nesne15->yapan15 + "</p>";
...
void proje_ekrani::on_bar_proje14_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/14.jpg' width='500' height='500' /></p><p>" + nesne14->metin14 + nesne14->yapan14 + "</p>";
...
void proje_ekrani::on_bar_proje16_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/16.jpg' width='500' height='500' /></p><p>" + nesne16->metin16 + nesne16->yapan16 + "</p>";
...
void proje_ekrani::on_bar_proje17_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/17.jpg' width='500' height='500' /></p><p>" + nesne17->metin17 + nesne17->yapan17 + "</p>";
...
void proje_ekrani::on_bar_proje18_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/18.jpg' width='500' height='500' /></p><p>" + nesne18->metin18 + nesne18->yapan18 + "</p>";
...
void proje_ekrani::on_bar_proje19_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/19.jpg' width='500' height='500' /></p><p>" + nesne19->metin19 + nesne19->yapan19 + "</p>";
...
void proje_ekrani::on_bar_proje22_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/22.jpg' width='500' height='500' /></p><p>" + nesne22->metin22 + nesne22->yapan22 + "</p>";
...
void proje_ekrani::on_bar_proje20_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/20.jpg' width='500' height='500' /></p><p>" + nesne20->metin20 + nesne20->yapan20 + "</p>";
...
void proje_ekrani::on_bar_proje21_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/21.jpg' width='500' height='500' /></p><p>" + nesne21->metin21 + nesne21->yapan21 + "</p>";
...
void proje_ekrani::on_bar_proje23_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/23.jpg' width='500' height='500' /></p><p>" + nesne23->metin23 + nesne23->yapan23 + "</p>";
...
void proje_ekrani::on_bar_proje24_triggered()
{
    ...
    const QString html1 = "<p align='center'><img src=':/photos/veriler/proje_fotorafları/24.jpg' width='500' height='500' /></p><p>" + nesne24->metin24 + nesne24->yapan24 + "</p>";
...
resim_ekrani::resim_ekrani() {
    setupUi(this);
    const QString css = "border-image: url(" + projeYol + ");";
    project_name_bar->showMessage(projeAd);
    view_picture->setStyleSheet(css);
}

void resim_ekrani::on_back_triggered()
{
    proje_ekrani *ekran = new proje_ekrani;
    ekran->show();
    ekran->getProject();
    delete this;
}

void proje_ekrani::getProject()
{
    switch (projeNo)
    {
        case 1: on_bar_proje1_triggered(); break;
        case 2: on_bar_proje2_triggered(); break;
        case 3: on_bar_proje3_triggered(); break;
        case 4: on_bar_proje4_triggered(); break;
        case 5: on_bar_proje5_triggered(); break;
        case 6: on_bar_proje6_triggered(); break;
        case 7: on_bar_proje7_triggered(); break;
        case 8: on_bar_proje8_triggered(); break;
        case 9: on_bar_proje9_triggered(); break;
        case 10: on_bar_proje10_triggered(); break;
        case 11: on_bar_proje11_triggered(); break;
        case 12: on_bar_proje12_triggered(); break;
        case 13: on_bar_proje13_triggered(); break;
        case 14: on_bar_proje14_triggered(); break;
        case 15: on_bar_proje15_triggered(); break;
        case 16: on_bar_proje16_triggered(); break;
        case 17: on_bar_proje17_triggered(); break;
        case 18: on_bar_proje18_triggered(); break;
        case 19: on_bar_proje19_triggered(); break;
        case 20: on_bar_proje20_triggered(); break;
        case 21: on_bar_proje21_triggered(); break;
        case 22: on_bar_proje22_triggered(); break;
        case 23: on_bar_proje23_triggered(); break;
        case 24: on_bar_proje24_triggered(); break;
        default: QApplication::quit();
    }
}
